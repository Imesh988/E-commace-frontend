...
const OrderDetailsPage = () => {
    ...
    return (
       <div className="bg-slate-50 min-h-screen font-sans antialiased text-slate-900 relative">
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute top-0 left-0 w-80 h-80 bg-emerald-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob"></div>
        <div className="absolute bottom-0 right-0 w-72 h-72 bg-emerald-100 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob animation-delay-4000"></div>
    </div>
    ...
    <div className="relative z-10 container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-6">
            <div className="space-y-1">
                <button 
                    ...
                    className="flex items-center text-xs font-bold text-slate-400 hover:text-slate-900 transition-all uppercase tracking-widest mb-4"
                >
                    <FiArrowLeft className="mr-2" /> Back to My Orders
                </button>
                <h1 className="text-3xl font-extrabold tracking-tight text-slate-900">
                    Order ID: <span className="text-slate-500 font-medium">#{order.order_id}</span>
                </h1>
            ...
            <button 
                ...
                className="flex items-center gap-2 px-5 py-2.5 bg-white border border-slate-200 rounded-lg text-sm font-bold text-slate-700 hover:border-slate-900 hover:bg-slate-900 hover:text-white transition-all shadow-sm"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-4">
                <div className="bg-white rounded-2xl border border-slate-200 shadow-xl p-8 sticky top-28">
